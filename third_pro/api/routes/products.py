...
from third_pro.schemas.products_schemas import ProductList, ProductRead, ProductSchema
from third_pro.schemas.messages import Message
from third_pro.repository.products_repository import ProductsRepository
from third_pro.db.errors import ProductNameAlreadyExists, EntityDoesNotExist
...
def delete_product(product_id: int):
    ...
    try:
        ...
        raise HTTPException(
            status_code=404, detail="Unregistered Product"
        )
